...
--
-- Changelog:
-- 1.0.0 - Initial modular configuration layer
--==============================================================--
...
Config.Assets = {
    ...
    Images = {
        Logo = "Logo.png",
        Orb = "Orb.png",
        SettingsButton = "dje079e-d810008d-670a-49a3-9c8e-2ef45bf3fe44.png",
    },
    Particles = {
...
Config.Runtime = {
    HitDistance = Config.Settings.Gameplay.HitDistance,
}
...
function Config:GetModuleURL(moduleName)
    ...
    return self.Project.RawRepository .. "/" .. self.GitHub.Modules .. "/" .. moduleName
end

function Config:GetAssetURL(folder, asset)
    assert(type(folder) == "string", "folder must be a string")
    assert(type(asset) == "string", "asset must be a string")
